...
public class MovimientoCuatroEsquinas implements Movimiento{
	...
	private Vector esquinaSupIzq = new Vector(new double[]{100,100});
	private Vector esquinaSupDer = new Vector(new double[]{AmbienteMovil.tamx-100,100});
	private Vector esquinaInfIzq = new Vector(new double[]{100,AmbienteMovil.tamy-100});
	private Vector esquinaInfDer = new Vector(new double[]{AmbienteMovil.tamx-100,AmbienteMovil.tamy-100});
