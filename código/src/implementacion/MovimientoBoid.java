...
public class MovimientoBoid implements Movimiento{
	...
	public Vector calcularVelocidad(Boid boid)
	{
		...
		tercerTermino = mejorAgente.getPosicion().clonar();//seguir al mejor agente		
	...
	{
		mejorAptitud = Double.POSITIVE_INFINITY;//la mejor aptitud es la mas pequeña
		Objetivo o = null;
	...
	public void evasionColisiones(Boid boid)
	{
		...
		for(Boid vecino : vecinos)
		{
			...
			distancia = pos.distancia(vecino.getPosicion());//esto ya lo habia calculado antes
