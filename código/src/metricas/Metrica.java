...
public class Metrica {
	...
	public void calcularMétricas()
	{
		...
		{						
			...
			Vector promedioPosicion = new Vector(dimension);//centro del conjunto de agentes
			...
			////////Calculando polarización,extension, colisiones y consistencias//////////
			...
			if(cantAgentesSinColision == 0)//si todos los agentes ya han colisionado
			{
				consExtension = 0.0;
	...
	private double factorColisiones(Boid b)//retorna 1 si el agente está colisionando
	{
