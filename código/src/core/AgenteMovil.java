...
public abstract  class AgenteMovil extends Agente {
	...
	public void draw()//Este metodo lo utiliza el paquete que me hizo Patrick para la simulación en 3D, cada subclase lo sobreescribe
	{
	...
	/*public static void evitarColisiones(Vector2D posicion, AgenteMovil agente, double distanciaEntreAgentes)
	{
		...
		for(AgenteMovil agenteActual:agentes)
		{
			...
			if(distancia < distanciaEntreAgentes)
			{
				...
				//pos = pos + [ radioEntreAgentes*( pos - posAgenteActual )/distancia ] - (pos - posAgenteActual)							
